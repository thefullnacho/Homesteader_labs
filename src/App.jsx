                        ...
                        <div className="bg-white text-stone-900 p-1 border-2 border-stone-900 shadow-[4px_4px_0px_0px_rgba(28,25,23,1)]">
                            <div className="p-4 border border-stone-200">
                                ...
                                <button
                                    ...
                                    className="w-full font-bold py-3 transition-all flex justify-center items-center gap-2 text-sm bg-stone-900 text-white hover:bg-stone-700 hover:scale-[1.02] active:scale-[0.98]"
                                >
                                    <Terminal size={14} />
                                    [ CONFIRM_PRINT_ORDER ]
                                </button>
