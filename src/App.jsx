...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-theme-main text-theme-main font-mono selection:bg-stone-900 selection:text-white flex flex-col relative overflow-x-hidden transition-colors duration-300">
